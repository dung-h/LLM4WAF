...
def main():
    ...
    parser.add_argument("--output_file", type=str, default="eval/red_rag_eval_dvwa_pl1_extended.jsonl")
    parser.add_argument("--output_summary", type=str, default="eval/red_rag_eval_dvwa_pl1_extended_summary.txt")
    args = parser.parse_args()

    cmd_str = f"python scripts/red_rag_eval_dvwa_pl1_extended.py --num_samples {args.num_samples}"
    ...
    try:
        ...
        with httpx.Client(base_url=DVWA_WAF_URL, timeout=15.0) as client:
            ...
            for mode in ["baseline", "rag_v2"]: # Changed mode to rag_v2 to signify using corpus_version="v2"
...
"""
        ...
        summary_content = []
        summary_content.append("--- RED RAG Extended Evaluation Summary (DVWA PL1) ---")
